...
const en = {
  ...
  about: "About",
  aboutPrefix: "About",
  viewImageFullSize: "View full-size image of",
  ...
  loadMoreProducts: "Load {count} more",
  viewAllProducts: "View all for Find / Print",
  showFirstProducts: "Show first {count}",
  viewAs: "View as",
  ...
  notFound: "Not found",
  added: "Added",
  requestTooLarge: "That request is too large. Split it into smaller batches.",
  rateLimited: "Too many requests. Wait a moment and try again.",
  cartFull: "Your order has reached its item limit. Remove an item before adding another.",
  invalidInput: "One or more fields are invalid or too long.",
  // RFQ
  ...
  quoteFormExpired: "This quote form expired. Review your cart and submit it again.",
  quoteCartChanged: "Your cart changed after this form opened. Review it and submit again.",
  // Admin
  admin: "Admin",
  ...
  fxManual: "Manual",
  fxPerUsd: "Rial / USD",
  fxMarketUpdatedAt: "market, updated {when} Tehran time",
  fxNoMarketYet: "no market reading yet — using USD_TO_RIAL",
  fxApply: "Apply",
  fxConfirm: "Confirm",
  fxCancel: "Cancel",
  ...
  fxMarketLatest: "Latest reading {date}",
  fxNobitex: "Nobitex",
  fxWallex: "Wallex",
  fxWeekAverage: "7-day average",
  fxMarketRule:
    "Automatic is the higher of the latest reading and its 7-day average, plus 3%. It updates every evening around 9 pm Tehran time from the Tether price on Nobitex and Wallex.",
  fxUpdateNow: "Update now",
  fxRefreshed: "Automatic rate updated",
  fxRefreshFailed:
    "The market reading was refused, so the automatic rate is unchanged. The reason is under the exchange rate.",
  fxLastFailed: "Last update refused at {when}:",
  fxReasonNoSource: "neither exchange answered.",
  fxReasonNeedsBoth: "only one exchange answered, and the first reading needs both to agree.",
  fxReasonDisagree: "the two exchanges disagree by more than 2%.",
  fxReasonJump:
    "the price moved further than the safety limit since the last reading. If the market really moved that much, set a manual rate.",
  fxKeptLastRate: "Prices keep the last good rate.",
  fxStale: "No market reading for more than 36 hours. Prices keep the last good rate.",
  // Invoice
  invoice: "Invoice",
  invoiceTo: "Bill to",
  invoiceFrom: "From",
  ...
  importStorageMissing: "Private import storage is not configured.",
  importUploadFailed: "The CSV upload could not be completed. Try again.",
  ...
  newProductTitle: "Add a product to {family}",
  newProductIntro:
  ...
  newProductBadNumber: "\"{column}\" needs a number.",
  newProductBadPrice: "The price is not a number.",
  newProductBadPack: "Pack quantity must be a whole number, 1 or more.",
  ...
  taxonomyArrangeFamilies: "Arrange families",
  taxonomyAllCategories: "All categories",
  taxonomyCategory: "Category",
  taxonomySubcategory: "Subcategory",
  taxonomyProductFamily: "Product family",
  taxonomyProductFamilies: "Product families",
  taxonomyFamilyTag: "family",
  taxonomyExpand: "Expand",
  taxonomyCollapse: "Collapse",
  taxonomyHideFromCatalog: "Hide {name} from catalog",
  taxonomyShowInCatalog: "Show {name} in catalog",
  taxonomyCategoryMeta: "{families} families · {products} products",
  taxonomyFamilyMeta: "{products} products · {imported}",
  taxonomyNeverImported: "never imported",
  taxonomyImportUnknown: "import date not recorded",
  taxonomyNoRowsImported: "no rows imported yet",
  taxonomyEditImageText: "Edit image & text",
  taxonomyImageText: "Image & text",
  taxonomyCloseImageText: "Close image & text",
  taxonomyFullSettings: "Names & visibility",
  taxonomyAddSubcategory: "Add subcategory",
  taxonomyAddFamily: "Add product family",
  taxonomySubcategoryBlockedTitle: "This node already holds product families.",
  taxonomyFamilyBlockedTitle: "This node already holds subcategories.",
  taxonomyRuleHasSubcategories:
    "{name} holds subcategories, so a product family cannot be added here. Add it inside one of them, or on a node with no children.",
  taxonomyRuleHasFamilies:
    "{name} holds product families, so a subcategory cannot be added here. Move or delete the families first.",
  taxonomyNewCategory: "New category",
  taxonomyNewSubcategory: "New subcategory",
  taxonomyNewFamily: "New product family",
  taxonomyName: "Name",
  taxonomyCreate: "Create",
  taxonomyUnder: "under {parent}",
  taxonomyTopLevel: "top level",
  taxonomyCreateNoName: "Enter a name.",
  taxonomyCreateParentGone: "That parent no longer exists. Reload and try again.",
  taxonomyCreateHasFamilies: "This category already holds product families.",
  taxonomyCreateHasSubcategories: "This category already holds subcategories.",
  taxonomyCreateDuplicate: "A sibling with that name already exists.",
  taxonomyCategoryImage: "category image",
  taxonomyFamilyImage: "family image",
  taxonomyDescription: "Description",
  taxonomyDescriptionEmpty:
    "No description yet. It shows as the callout above the list on the catalog page.",
  taxonomyDropImage: "drop image",
  taxonomyBrowse: "or browse",
  taxonomyImageRequirements: "JPG / PNG / WebP · 4 MB max",
  taxonomyCategoryDescription: "Category description",
  taxonomyFamilyDescription: "Family description",
  taxonomySaveImageText: "Save image & text",
  taxonomyAppliesOnly: "Applies to {name} only.",
  taxonomySubcategories: "Subcategories",
  taxonomySubcategoriesHint: "families live inside these, or one level deeper",
  taxonomyNoFamiliesNote: "no families yet",
  taxonomyOpen: "Open",
  taxonomyFamilyOrderHint: "order shown is catalog order",
  taxonomyNoFamiliesYet: "No families here yet.",
  taxonomyEmptyTopHint: "A family added here sits directly under the {name} category.",
  taxonomyEmptyDepthHint: "A family added here sits {depth} levels down, under {name}.",
  taxonomyCatalogImport: "Catalog import",
  taxonomyUnderBreadcrumb: "under {path}",
  taxonomyPendingOne: "1 pending change",
  taxonomyPendingMany: "{n} pending changes",
  taxonomySaveAll: "Save all",
  taxonomySaved: "All changes saved.",
  taxonomySaveStale:
    "Nothing was saved. The taxonomy changed after this page loaded; reload and arrange it again.",
  taxonomySaveBadData: "Nothing was saved. Check the edited fields and try again.",
  taxonomyUnsavedTitle: "Unsaved taxonomy changes",
  taxonomyUnsavedBody: "{n} have not been saved. Leaving now loses those changes.",
  taxonomyNoCategories: "There are no catalog categories yet.",
  // Deleting
  ...
  columnsDetail: "Detail view",
  columnsDetailHint:
    "Untick both Catalog table and Detail view to hide a column everywhere. Its values are kept.",
...
const fa: typeof en = {
  ...
  about: "درباره",
  aboutPrefix: "درباره",
  viewImageFullSize: "نمایش تصویر در اندازهٔ کامل:",
  ...
  viewAll: "مشاهده همه",
  productDisplay: "نمایش کالاها",
  showingProducts: "نمایش {shown} از {total} کالا",
  showingAllProducts: "نمایش همه {total} کالا",
  loadMoreProducts: "نمایش {count} مورد دیگر",
  viewAllProducts: "نمایش همه برای جست‌وجو / چاپ",
  showFirstProducts: "نمایش {count} مورد نخست",
  ...
  notFound: "یافت نشد",
  added: "افزوده شد",
  requestTooLarge: "حجم درخواست بیش از حد مجاز است. آن را به بخش‌های کوچک‌تر تقسیم کنید.",
  rateLimited: "تعداد درخواست‌ها بیش از حد است. کمی صبر کنید و دوباره تلاش کنید.",
  cartFull: "سفارش شما به سقف تعداد اقلام رسیده است. ابتدا یک قلم را حذف کنید.",
  invalidInput: "یک یا چند فیلد نامعتبر یا بیش از حد طولانی است.",
  ...
  quoteFormExpired: "اعتبار این فرم به پایان رسیده است. سفارش را بررسی و دوباره ثبت کنید.",
  quoteCartChanged: "سفارش شما پس از باز شدن این فرم تغییر کرده است. آن را بررسی و دوباره ثبت کنید.",
  admin: "مدیریت",
  ...
  fxMarketUpdatedAt: "بازار، به‌روزرسانی {when} به وقت تهران",
  fxNoMarketYet: "هنوز قیمت بازار دریافت نشده — از USD_TO_RIAL",
  fxApply: "اعمال",
  fxConfirm: "تأیید",
  fxCancel: "انصراف",
  ...
  fxMarketLatest: "آخرین قیمت {date}",
  fxNobitex: "نوبیتکس",
  fxWallex: "والکس",
  fxWeekAverage: "میانگین ۷ روزه",
  fxMarketRule:
    "نرخ خودکار، بیشترینِ آخرین قیمت و میانگین ۷ روزه‌ی آن به‌علاوه‌ی ۳٪ است. هر شب حدود ساعت ۹ به وقت تهران از قیمت تتر در نوبیتکس و والکس به‌روزرسانی می‌شود.",
  fxUpdateNow: "به‌روزرسانی اکنون",
  fxRefreshed: "نرخ خودکار به‌روزرسانی شد",
  fxRefreshFailed:
    "قیمت بازار پذیرفته نشد و نرخ خودکار تغییری نکرد. دلیل آن زیر بخش نرخ ارز آمده است.",
  fxLastFailed: "آخرین به‌روزرسانی در {when} رد شد:",
  fxReasonNoSource: "هیچ‌یک از دو صرافی پاسخ نداد.",
  fxReasonNeedsBoth: "فقط یک صرافی پاسخ داد و نخستین قیمت باید با تأیید هر دو ثبت شود.",
  fxReasonDisagree: "اختلاف قیمت دو صرافی بیش از ۲٪ است.",
  fxReasonJump:
    "تغییر قیمت نسبت به آخرین قیمت از حد ایمنی بیشتر است. اگر بازار واقعاً این‌قدر تغییر کرده، نرخ را دستی تعیین کنید.",
  fxKeptLastRate: "قیمت‌ها با آخرین نرخ معتبر نمایش داده می‌شوند.",
  ...
  importStorageMissing: "فضای ذخیره‌سازی خصوصی برای ورود اطلاعات پیکربندی نشده است.",
  importUploadFailed: "بارگذاری فایل CSV انجام نشد. دوباره تلاش کنید.",
  ...
  newProduct: "افزودن کالا",
  newProductTitle: "افزودن کالا به {family}",
  newProductIntro:
  ...
  newProductBadNumber: "«{column}» باید عدد باشد.",
  newProductBadPrice: "قیمت عدد نیست.",
  newProductBadPack: "تعداد در بسته باید عدد درست و دست‌کم ۱ باشد.",
  ...
  taxonomyArrangeFamilies: "چیدمان خانواده‌ها",
  taxonomyAllCategories: "همه دسته‌بندی‌ها",
  taxonomyCategory: "دسته‌بندی",
  taxonomySubcategory: "زیردسته",
  taxonomyProductFamily: "خانواده کالا",
  taxonomyProductFamilies: "خانواده‌های کالا",
  taxonomyFamilyTag: "خانواده",
  taxonomyExpand: "باز کردن",
  taxonomyCollapse: "بستن",
  taxonomyHideFromCatalog: "پنهان کردن {name} از کاتالوگ",
  taxonomyShowInCatalog: "نمایش {name} در کاتالوگ",
  taxonomyCategoryMeta: "{families} خانواده · {products} کالا",
  taxonomyFamilyMeta: "{products} کالا · {imported}",
  taxonomyNeverImported: "هنوز بارگذاری نشده",
  taxonomyImportUnknown: "تاریخ بارگذاری ثبت نشده",
  taxonomyNoRowsImported: "هنوز ردیفی بارگذاری نشده",
  taxonomyEditImageText: "ویرایش تصویر و متن",
  taxonomyImageText: "تصویر و متن",
  taxonomyCloseImageText: "بستن تصویر و متن",
  taxonomyFullSettings: "نام‌ها و نمایش",
  taxonomyAddSubcategory: "افزودن زیردسته",
  taxonomyAddFamily: "افزودن خانواده کالا",
  taxonomySubcategoryBlockedTitle: "این مورد از قبل خانواده کالا دارد.",
  taxonomyFamilyBlockedTitle: "این مورد از قبل زیردسته دارد.",
  taxonomyRuleHasSubcategories:
    "{name} زیردسته دارد؛ بنابراین نمی‌توان اینجا خانواده کالا افزود. آن را داخل یکی از زیردسته‌ها یا گرهی بدون فرزند اضافه کنید.",
  taxonomyRuleHasFamilies:
    "{name} خانواده کالا دارد؛ بنابراین نمی‌توان اینجا زیردسته افزود. ابتدا خانواده‌ها را جابه‌جا یا حذف کنید.",
  taxonomyNewCategory: "دسته‌بندی جدید",
  taxonomyNewSubcategory: "زیردسته جدید",
  taxonomyNewFamily: "خانواده کالای جدید",
  taxonomyName: "نام",
  taxonomyCreate: "ایجاد",
  taxonomyUnder: "زیر {parent}",
  taxonomyTopLevel: "سطح اصلی",
  taxonomyCreateNoName: "نام را وارد کنید.",
  taxonomyCreateParentGone: "دسته‌بندی والد دیگر وجود ندارد. صفحه را تازه کنید.",
  taxonomyCreateHasFamilies: "این دسته‌بندی از قبل خانواده کالا دارد.",
  taxonomyCreateHasSubcategories: "این دسته‌بندی از قبل زیردسته دارد.",
  taxonomyCreateDuplicate: "مورد هم‌سطحی با این نام از قبل وجود دارد.",
  taxonomyCategoryImage: "تصویر دسته‌بندی",
  taxonomyFamilyImage: "تصویر خانواده",
  taxonomyDescription: "توضیحات",
  taxonomyDescriptionEmpty:
    "هنوز توضیحی ثبت نشده است. این متن بالای فهرست در صفحه کاتالوگ نمایش داده می‌شود.",
  taxonomyDropImage: "تصویر را رها کنید",
  taxonomyBrowse: "یا انتخاب کنید",
  taxonomyImageRequirements: "JPG / PNG / WebP · حداکثر ۴ مگابایت",
  taxonomyCategoryDescription: "توضیحات دسته‌بندی",
  taxonomyFamilyDescription: "توضیحات خانواده",
  taxonomySaveImageText: "ذخیره تصویر و متن",
  taxonomyAppliesOnly: "فقط برای {name} اعمال می‌شود.",
  taxonomySubcategories: "زیردسته‌ها",
  taxonomySubcategoriesHint: "خانواده‌ها داخل این موارد یا یک سطح پایین‌تر قرار می‌گیرند",
  taxonomyNoFamiliesNote: "هنوز خانواده‌ای ندارد",
  taxonomyOpen: "باز کردن",
  taxonomyFamilyOrderHint: "این ترتیب در کاتالوگ نمایش داده می‌شود",
  taxonomyNoFamiliesYet: "هنوز خانواده‌ای اینجا نیست.",
  taxonomyEmptyTopHint: "خانواده‌ای که اینجا اضافه شود مستقیماً زیر دسته‌بندی {name} قرار می‌گیرد.",
  taxonomyEmptyDepthHint: "خانواده‌ای که اینجا اضافه شود در عمق {depth} و زیر {name} قرار می‌گیرد.",
  taxonomyCatalogImport: "بارگذاری کاتالوگ",
  taxonomyUnderBreadcrumb: "زیر {path}",
  taxonomyPendingOne: "۱ تغییر در انتظار",
  taxonomyPendingMany: "{n} تغییر در انتظار",
  taxonomySaveAll: "ذخیره همه",
  taxonomySaved: "همه تغییرات ذخیره شد.",
  taxonomySaveStale:
    "چیزی ذخیره نشد. ساختار کاتالوگ پس از باز شدن صفحه تغییر کرده است؛ صفحه را تازه و دوباره مرتب کنید.",
  taxonomySaveBadData: "چیزی ذخیره نشد. فیلدهای ویرایش‌شده را بررسی و دوباره تلاش کنید.",
  taxonomyUnsavedTitle: "تغییرات ذخیره‌نشده ساختار",
  taxonomyUnsavedBody: "{n} هنوز ذخیره نشده است. با خروج، این تغییرات از دست می‌روند.",
  taxonomyNoCategories: "هنوز دسته‌بندی کاتالوگی وجود ندارد.",
  // Deleting
  ...
  columnsDetail: "نمای جزئیات",
  columnsDetailHint:
    "برای پنهان کردن کامل یک ستون، هم «جدول کاتالوگ» و هم «نمای جزئیات» را بردارید. مقادیر آن حفظ می‌شود.",
